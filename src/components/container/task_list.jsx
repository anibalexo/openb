...
const TaskListComponent = () => {
    ...
    function completeTask(task){
        ...
        // we update the state of the component with the new list of task and it will 
        // update the iteration of the task in order to show the task updated
        setTasks(tempTasks);
    }
